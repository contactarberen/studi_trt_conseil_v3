 ...
 */
final class Version20230318091038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, id_type_contrat_id INT NOT NULL, user_id_id INT NOT NULL, intitule_poste VARCHAR(255) NOT NULL, lieu_travail VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, horaires VARCHAR(255) NOT NULL, salaire INT NOT NULL, etat VARCHAR(255) DEFAULT NULL, INDEX IDX_F65593E5EC7E13B2 (id_type_contrat_id), INDEX IDX_F65593E59D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, displayed_role_id_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D6495EA85E6 (displayed_role_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
