 ...
 */
final class Version20230323202051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attributs_candidat (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, cv LONGTEXT DEFAULT NULL, image LONGTEXT DEFAULT NULL, INDEX IDX_DC87DF2E9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE candidature (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, annonce_id_id INT DEFAULT NULL, is_valid TINYINT(1) NOT NULL, INDEX IDX_E33BD3B89D86650F (user_id_id), INDEX IDX_E33BD3B868C955C8 (annonce_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, displayed_role_id_id INT DEFAULT NULL, attr_recruteur_id_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, actif TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D6495EA85E6 (displayed_role_id_id), UNIQUE INDEX UNIQ_8D93D64980DDFF02 (attr_recruteur_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE attributs_candidat ADD CONSTRAINT FK_DC87DF2E9D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE candidature ADD CONSTRAINT FK_E33BD3B89D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attributs_candidat DROP FOREIGN KEY FK_DC87DF2E9D86650F');
        $this->addSql('ALTER TABLE candidature DROP FOREIGN KEY FK_E33BD3B89D86650F');
